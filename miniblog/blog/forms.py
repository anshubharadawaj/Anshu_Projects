...
class SignUpForm(UserCreationForm):
    ...
    password2 = forms.CharField(label='Confirm Password(again)', label_suffix=" ",widget=forms.PasswordInput(attrs={'class': 'form-control'}))
    class Meta:
        model=User
...
class PostForm(forms.ModelForm):
    class Meta:
        model=Post
        fields=['title', 'desc']
        labels={'title':'Titlte', 'desc':'description'}
